...
Route.group(() => {
  ...
  Route.get('/listar-grupos', 'UsuariosController.getListarUsuariosGrupos')

  Route.get('/buscar-id/:id', 'UsuariosController.buscarPorId')
  Route.get('/filtrar-usuario', 'UsuariosController.filtrarPorNombre')
  ...
  Route.post('/registro-grupo', 'GrupoController.setRegistrarGrupo')
